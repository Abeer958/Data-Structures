...
// Use script.js to test TreeNode.
// The code below swaps two items from the breakfast and the dinner menu.
// In the solution code below you can see how that is fixed using TreeNode.
...
// "Solution" - uncomment the code below to fix the menu:
...
// Uncomment to see the different traversal styles in action:
